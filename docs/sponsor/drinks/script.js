jQuery(document).ready(function () {
  ...
  var GithubLink =
    "https://github.com/EchoHeim/Astapb/tree/master/docs/sponsor";
  ...
  var qrcodes = {
    btc_donate:
      "https://cdn.jsdelivr.net/gh/EchoHeim/Astapb/docs/sponsor/images/QQPayQR.png", // 二维码路径
    alipay_donate:
      "https://cdn.jsdelivr.net/gh/EchoHeim/Astapb/docs/sponsor/images/AliPayQR.png", // 支付宝二维码
  ...
  drinks_an[0] = function () {
    drink_box_s
      .removeClass("donate-animation-2 donate-animation-3")
      .addClass("donate-animation-1");
  ...
  drinks_an[1] = function () {
    drink_box_s
      .removeClass("donate-animation-1 donate-animation-3")
      .addClass("donate-animation-2");
    setTimeout(() => {
  ...
  drinks_an[2] = function () {
    drink_box_s
      .removeClass("donate-animation-2 donate-animation-1")
      .addClass("donate-animation-3");
  ...
  drinks_an[3] = function () {
    drink_box_s
      .removeClass("donate-animation-3 donate-animation-2")
      .addClass("donate-animation-4");
    setTimeout(() => {
