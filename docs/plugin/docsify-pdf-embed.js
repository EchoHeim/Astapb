    ...
    var pdf_renderer = function (code, lang, verify) {
      ...
      if (lang && !lang.localeCompare('pdf', 'en', { sensitivity: 'base' })) {
        if (verify) {
          ...
          var divId =
            'markdown_code_pdf_container_' + unique_id_generator().toString()
        ...
        if (container_list) {
          ...
          if (mobile_view) {
            ...
            container_list.forEach(function (container) {
              var absolute_pdf_location = url_check(container['pdf_location'])
                ? container['pdf_location']
                : build_absolute_path(container['pdf_location'])
              var view_location =
