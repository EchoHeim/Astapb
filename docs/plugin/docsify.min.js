!(function () {
  ...
  var p = document,
    ...
    f = p.head
  function b(e, t) {
    return t ? e.querySelector(t) : p.querySelector(e)
  }
  function y(e, t) {
    return [].slice.call(t ? e.querySelectorAll(t) : p.querySelectorAll(e))
  }
  function k(e, t) {
    return (e = p.createElement(e)), t && (e.innerHTML = t), e
  }
  function w(e, t) {
  ...
  function C(e) {
    ...
    $ ||
      (function () {
        var e = k('div')
        e.classList.add('progress'), w(v, e), ($ = e)
      })(),
      (t = i
        ? 80 < (t = parseInt($.style.width || 0, 10) + i)
          ? 80
          : t
        : Math.floor((n / r) * 100)),
      ($.style.opacity = 1),
  ...
  function L(a, e, t) {
    ...
    for (var i in (s.open('GET', a), t))
      l.call(t, i) && s.setRequestHeader(i, t[i])
    return (
      s.send(),
      {
        then: function (r, i) {
          if ((void 0 === i && (i = h), e)) {
            var t = setInterval(function (e) {
              return C({ step: Math.floor(5 * Math.random() + 1) })
            }, 500)
            n('progress', C),
          ...
          n('error', i),
            n('load', function (e) {
              ...
              if (400 <= t.status) i(t)
                ...
                var n = (F[a] = {
                  content: t.response,
                  opt: { updatedAt: s.getResponseHeader('last-modified') },
                })
                r(n.content, n.opt)
              }
            })
  ...
  function z(e, t, r, n) {
    ...
    null != (t = m(t)) && (i = y(t, 'a'))
    var a,
      s = decodeURI(e.toURL(e.getCurrentPath()))
    return (
      i
        .sort(function (e, t) {
      ...
      n && (p.title = a ? a.title || a.innerText + ' - ' + O : O),
      a
    )
  }
  ...
  function q(e, t) {
    ...
    for (var r in e)
      -1 < t.indexOf(r) ||
        n.push(e[r] ? (N(r) + '=' + N(e[r])).toLowerCase() : N(r))
  ...
  function X() {
    ...
    !(function (e, t) {
      ...
      (this.tweener = e.tweener || new t(e)),
    ...
    if (ee) {
      for (
        var t,
          ...
          o = ((s && s.scrollTop) || document.body.scrollTop) - te,
          l = 0,
          c = r.length;
        l < c;
        l += 1
      ...
      if (t) {
        var h = Q[re(decodeURIComponent(e), t.getAttribute('data-id'))]
        if (
          h &&
          h !== a &&
          ...
          (a = h),
          !J && v.classList.contains('sticky'))
        ) {
          var p = n.clientHeight,
            d = a.offsetTop + a.clientHeight + 40,
            g = d - 0 < p,
            f =
              a.offsetTop >= i.scrollTop && d <= i.scrollTop + p
                ? i.scrollTop
                : g
                ? 0
                : d - p
  ...
  var ae = p.scrollingElement || p.documentElement
  function se(e, t) {
    if (
  ...
  function pe(e) {
    ...
    var t = e
        ...
        .replace(/^(\d)/, '_$1'),
      n = ce[t]
    return (n = l.call(ce, t) ? n + 1 : 0), (ce[t] = n) && (t = t + '-' + n), t
  }
  function de(e, t) {
    return (
          ...
          T = {
              ...
              clone: function n(e, r) {
                ...
                switch (((r = r || {}), a)) {
                  case 'Object':
                    ...
                    for (var s in ((i = {}), (r[t] = i), e))
                      e.hasOwnProperty(s) && (i[s] = n(e[s], r))
                    return i
                  case 'Array':
                    return (
                      (t = T.util.objId(e)),
            ...
            highlightAllUnder: function (e, t, n) {
              ...
              for (var i, a = 0; (i = r.elements[a++]); )
                T.highlightElement(i, !0 === t, r.callback)
            },
            highlightElement: function (e, t, n) {
              ...
              if ((T.hooks.run('before-sanity-check', s), !s.code))
                return T.hooks.run('complete', s), void (n && n.call(s.element))
              if ((T.hooks.run('before-highlight', s), s.grammar))
                if (t && c.Worker) {
                ...
                } else o(T.highlight(s.code, s.grammar, s.language))
              else o(T.util.encode(s.code))
            },
                    ...
                    for (
                      ...
                      if (!(y instanceof R)) {
                        if (d && v != t.length - 1) {
                          ...
                          for (
                            var k = A.index + (p && A[1] ? A[1].length : 0),
                              w = A.index + A[0].length,
                              x = v,
                              _ = b,
                              S = t.length;
                            x < S &&
                            (_ < w || (!t[x].type && !t[x - 1].greedy));
                            ++x
                          )
                            (_ += t[x].length) <= k && (++v, (b = _))
                        ...
                        if (A) {
                          ...
                          if (
                            ...
                            1 != $ &&
                              T.matchGrammar(e, t, n, v, b, !0, o + ',' + c),
                            a)
                          )
                            break
                        } else if (a) break
  ...
  ;(ve = Prism),
    Object.defineProperties((ve.languages['markup-templating'] = {}), {
      buildPlaceholders: {
        value: function (r, i, e, a) {
          if (r.language === i) {
            ...
            ;(r.code = r.code.replace(e, function (e) {
              ...
              for (var t, n = s.length; -1 !== r.code.indexOf((t = ye(i, n))); )
                ++n
              return (s[n] = e), t
            })),
              (r.grammar = ve.languages.markup)
          }
        },
      },
  ...
  var ke = me(function (v, e) {
      !(function () {
        ...
        function l(e) {
          ;(this.tokens = []),
            ...
            this.options.pedantic
              ...
              : this.options.gfm && (this.rules = y.gfm)
        }
        ;(y._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/),
          (y._title =
            /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/),
          ...
          (y.pedantic = d({}, y.normal, {
            ...
            heading: /^ *(#{1,6}) *([^\n]+?) *(?:#+ *)?(?:\n+|$)/,
            fences: h,
            paragraph: e(y.normal._paragraph)
              .replace('hr', y.hr)
              .replace('heading', ' *#{1,6} *[^\n]')
              ...
              if (
                ...
                for (
                  ...
                  /^ *-+: *$/.test(o.align[p])
                    ...
                    ? (o.align[p] = 'left')
                    : (o.align[p] = null)
                for (p = 0; p < o.cells.length; p++)
                  o.cells[p] = w(o.cells[p], o.header.length)
                this.tokens.push(o)
                  ...
                  (h = (o = i[p]).length),
                    ~(o = o.replace(/^ *([*+-]|\d+\.) */, '')).indexOf('\n ') &&
                      ...
                      (o = this.options.pedantic
                        ? o.replace(/^ {1,4}/gm, '')
                        : o.replace(new RegExp('^ {1,' + h + '}', 'gm'), ''))),
                    p !== g - 1 &&
                      ((s = y.bullet.exec(i[p + 1])[0]),
                      (1 < a.length
                        ? 1 === s.length
                        : 1 < s.length ||
                ...
                if (l.loose)
                  for (g = c.length, p = 0; p < g; p++) c[p].loose = !0
        ...
        function k(e, t) {
          if (t) {
            if (k.escapeTest.test(e))
              return e.replace(k.escapeReplace, function (e) {
                return k.replacements[e]
              })
          } else if (k.escapeTestNoEncode.test(e))
            return e.replace(k.escapeReplaceNoEncode, function (e) {
              return k.replacements[e]
            })
          return e
        }
        ...
        ;(n._punctuation = '!"#$%&\'()*+,\\-./:;<=>?@\\[^_{|}~'),
          ...
          (u.prototype.output = function (e) {
            for (var t, n, r, i, a, s, o = ''; e; )
              if ((a = this.rules.escape.exec(e)))
                (e = e.substring(a[0].length)), (o += k(a[1]))
                ...
                if ((a = this.rules.text.exec(e)))
                  (e = e.substring(a[0].length)),
                    this.inRawBlock
                      ...
                      : (o += this.renderer.text(k(this.smartypants(a[0]))))
                else if (e)
                  throw new Error('Infinite loop on byte: ' + e.charCodeAt(0))
              } else {
          ...
          (r.prototype.link = function (e, t, n) {
            if (
              null === (e = a(this.options.sanitize, this.options.baseUrl, e))
            )
              return n
            var r = '<a href="' + k(e) + '"'
          ...
          (c.prototype.parse = function (e) {
            ;(this.inline = new u(e.links, this.options)),
              (this.inlineText = new u(
                e.links,
                d({}, this.options, { renderer: new i() })
              )),
          ...
          (c.prototype.tok = function () {
            switch (this.token.type) {
              ...
              case 'list_start':
                a = ''
                for (
                  var s = this.token.ordered, o = this.token.start;
              ...
              case 'list_item_start':
                ...
                var l = this.token.loose,
                  ...
                  u = this.token.task
                for (
                  this.token.task && (a += this.renderer.checkbox(c));
          ...
          (k.escapeTestNoEncode = /[<>"']|&(?!#?\w+;)/),
          (k.escapeReplaceNoEncode = /[<>"']|&(?!#?\w+;)/g)
        var s = {},
          o = /^$|^[a-z][a-z0-9+.-]*:|^[?#]/i
        function h() {}
        function d(e) {
    ...
    _e = function (i, e) {
      ...
      ;(s = r(n)
        ? n(ke, t)
        : (ke.setOptions(d(n, { renderer: d(t, n.renderer) })), ke)),
        (this._marked = s),
                  ...
                  (t = i.noEmoji
                    ...
                    : (function (e) {
                        return e
                          ...
                          .replace(/:(\w+?):/gi, window.emojify || de)
                          .replace(/__colon__/g, ':')
                      })(t)),
                  pe.clear(),
                  t)
  ...
  ;(_e.prototype.compileEmbed = function (e, t) {
    var n,
      r = ge(t),
      i = r.str,
      a = r.config
    if (((t = i), a.include)) {
      var s
      if (
        (H(e) || (e = D(this.contentBase, I(this.router.getCurrentPath()), e)),
        a.type && (s = xe[a.type]))
      )
        (n = s.call(this, e, t)).type = a.type
      else {
        var o = 'code'
        ;/\.(md|markdown)/.test(e)
          ? (o = 'markdown')
          ...
          ? (o = 'video')
          : /\.mp3/.test(e) && (o = 'audio'),
          ((n = xe[o].call(this, e, t)).type = o)
      }
      return (n.fragment = a.fragment), n
    }
  }),
    (_e.prototype._matchNotCompileLink = function (e) {
      for (var t = this.config.noCompileLinks || [], n = 0; n < t.length; n++) {
        var r = t[n]
        if ((we[r] || (we[r] = new RegExp('^' + r + '$'))).test(e)) return e
      }
    }),
    (_e.prototype._initRenderer = function () {
      var e = new ke.Renderer(),
        t = this.linkTarget,
        l = this.router,
        n = this.contentBase,
        c = this,
      ...
      return (
          ...
          function (e, t) {
            ...
            ;/{docsify-ignore}/g.test(r) &&
              ...
              /{docsify-ignore-all}/g.test(r) &&
                ...
                (a.ignoreAllSubs = !0))
            var s = pe(i.id || r),
              o = l.toURL(l.getCurrentPath(), { id: s })
            return (
              (a.slug = o),
              c.toc.push(a),
              '<h' +
        ...
        (r.code = (function (e) {
          return (e.renderer.code = function (e, t) {
            void 0 === t && (t = '')
            var n = be.languages[t] || be.languages.markup
            return (
              '<pre v-pre data-lang="' +
              t +
              '"><code class="lang-' +
        ...
        (r.link = (function (e) {
          ...
          return (t.link = function (e, t, n) {
            ...
            return (
              (t = a),
              H(e) || c._matchNotCompileLink(e) || s.ignore
                ? (!H(e) &&
                    e.startsWith('./') &&
                    (e =
              ...
              s.target && r.push('target="' + s.target + '"'),
              s.disabled && (r.push('disabled'), (e = 'javascript:void(0)')),
              s.class && r.push('class="' + s.class + '"'),
              s.id && r.push('id="' + s.id + '"'),
              t && r.push('title="' + t + '"'),
              '<a href="' + e + '" ' + r.join(' ') + '>' + n + '</a>'
            )
          })
        })({ renderer: e, router: l, linkTarget: t, compilerClass: c })),
        ...
        (r.image = (function (e) {
          ...
          return (t.image = function (e, t, n) {
            ...
            if (
              ...
              var l = o.size.split('x'),
                c = l[0],
                u = l[1]
              u
                ? i.push('width="' + c + '" height="' + u + '"')
                : i.push('width="' + c + '" height="' + c + '"')
            }
            return (
              o.class && i.push('class="' + o.class + '"'),
              o.id && i.push('id="' + o.id + '"'),
              H(e) || (r = D(h, I(p.getCurrentPath()), e)),
              0 < i.length
                ? '<img src="' +
                  r +
                  '" data-origin="' +
        ...
        })({ renderer: e, contentBase: n, router: l })),
        (r.list = (function (e) {
    ...
    (_e.prototype.sidebar = function (e, t) {
      var n = this.toc,
      ...
      if (e) i = this.compile(e)
        ...
        for (var a = 0; a < n.length; a++)
          if (n[a].ignoreSubHeading) {
            var s = n[a].level
            n.splice(a, 1)
            for (var o = a; s < n[o].level && o < n.length; o++)
              n.splice(o, 1) && o-- && a++
            a--
          }
        var l = this.cacheTree[r] || le(n, t)
        ;(i = se(l, '<ul>{inner}</ul>')), (this.cacheTree[r] = l)
      }
      return i
    }),
    (_e.prototype.subSidebar = function (e) {
      if (e) {
        ...
        var a = n[t] || le(r, e)
        return (n[t] = a), (this.toc = []), se(a)
      }
      this.toc = []
    }),
    (_e.prototype.header = function (e, t) {
      return this.heading(e, t)
    }),
    (_e.prototype.article = function (e) {
      return this.compile(e)
    }),
    (_e.prototype.cover = function (e) {
      ...
      for (; (t = n[l++]); ) {
        var r = (function (a) {
          return function (e) {
            ...
            s({ token: a, embedToken: t }), ++c >= l && s({})
          }
        })(t)
        t.embed.url ? L(t.embed.url).then(r) : r(t.embed.html)
      }
                    ...
                    a.push(
                      (i && i[t]) ||
                        function (e) {
                          return (
                            '00' +
                            ('string' == typeof Ce[t] ? e[Ce[t]]() : Ce[t](e))
                          ).slice(-t.length)
                        }
                    )
                }),
  ...
  function Te(e) {
    ;(e = e || '<h1>404 - Not found</h1>'),
      ...
      !1 === this.config.executeScript || void 0 === window.Vue || Fe()
        ? this.config.executeScript && Fe()
        : setTimeout(function (e) {
    ...
    if (i) {
      if (
          ...
          (a += (function () {
            ...
            return (
              ...
              ('linear-gradient(to left bottom, hsl(' +
                ...
                e +
                ') 100%)') +
              '"><div class="cover-main">\x3c!--cover--\x3e</div><div class="mask"></div></section>'
            )
          })()),
        t.logo)
      ) {
        var o = /^data:image/.test(t.logo),
          ...
          c = /^\./.test(t.logo)
        o || l || c || (t.logo = D(e.router.getBasePath(), t.logo))
      }
      ;(a += (function (e) {
        var t = e.name ? e.name : '',
          n =
        ...
        (function (n) {
          if (
            ...
            ;[].forEach.call(e, function (e) {
              if ('STYLE' === e.nodeName) T(e, n)
              else if ('LINK' === e.nodeName) {
                var t = e.getAttribute('href')
                if (!/\.css$/.test(t)) return
                L(t).then(function (e) {
                  var t = k('style', e)
                  f.appendChild(t), T(t, n)
                })
              }
            })
          }
  ...
  ;(Pe.prototype.getBasePath = function () {
    return this.config.basePath
  }),
    (Pe.prototype.getFile = function (e, t) {
            ...
            (e = n.alias
              ? (function e(t, n, r) {
                  var i = Object.keys(n).filter(function (e) {
                    return (
                      (Oe[e] || (Oe[e] = new RegExp('^' + e + '$'))).test(t) &&
                      t !== r
                    )
                  })[0]
                  return i ? e(t.replace(Oe[i], n[i]), n, t) : t
                })(e, n.alias)
              : e),
            i
          )) ===
    ...
    (Pe.prototype.onchange = function (e) {
      void 0 === e && (e = h), e()
    }),
    (Pe.prototype.getCurrentPath = function () {}),
    (Pe.prototype.normalize = function () {}),
    (Pe.prototype.parse = function () {}),
    (Pe.prototype.toURL = function (e, t, n) {
      var r = n && '#' === e[0],
        i = this.parse(U(e))
      if (
        ((i.query = d({}, i.query, t)),
        (e = (e = i.path + q(i.query)).replace(/\.md(\?)|\.md$/, '$1')),
        r)
      ) {
        var a = n.indexOf('?')
      ...
      return (
        ...
        (e.prototype.parse = function (e) {
          ...
          return (
            ...
            { path: e, file: this.getFile(e, !0), query: M(t) }
          )
        }),
    ...
    Ne = (function (t) {
      ...
      return (
        ...
        (e.prototype.parse = function (e) {
          ...
          var r = D(location.origin),
            i = e.indexOf(r)
          return (
            -1 < i && (e = e.slice(i + r.length)),
            { path: e, file: this.getFile(e), query: M(t) }
          )
        }),
        e
      )
  ...
  function He(e) {
    !(function (e) {
      ...
      null != (e = m(e)) &&
        (_(e, 'click', function (e) {
          e.stopPropagation(), t()
        }),
        g &&
          _(v, 'click', function (e) {
        ...
        null != (e = m(e)) &&
          _(e, 'click', function (e) {
            ...
            'A' === t.nodeName &&
              ...
              A(t.parentNode, 'collapse')
          })
      })('.sidebar', e.router),
      e.config.coverpage ? g || _('scroll', P) : v.classList.add('sticky')
  }
  function Ie(t, n, r, i, a, e) {
    ;(t = e ? t : t.replace(/\/$/, '')),
      (t = I(t)) &&
        L(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(
          i,
          function (e) {
            return Ie(t, n, r, i, a)
          }
  ...
  var De,
    ...
    We = Ze.prototype
  function Ge(e, t, n) {
    return Ye && Ye.abort && Ye.abort(), (Ye = L(e, !0, n))
  }
  ;(We._init = function () {
    var e = this
    ;(e.config = s()),
      ...
      (function (t) {
        var e,
          n = t.config
        ;(e =
          'history' === (n.routerMode || 'hash') && u ? new Ne(n) : new je(n)),
          (t.router = e),
          qe(t),
          (Me = t.route),
          e.onchange(function (e) {
            qe(t),
              t._updateRender(),
              Me.path !== t.route.path
                ? (t.$fetch(h, t.$resetEvents.bind(t, e.source)),
                  (Me = t.route))
      ...
      (function (t) {
        ...
        if (t.rendered) {
          var n = z(t.router, '.sidebar-nav', !0, !0)
    ...
    (We.route = {}),
    ((De = We)._renderTo = function (e, t, n) {
      var r = m(e)
      r && (r[n ? 'outerHTML' : 'innerHTML'] = t)
    }),
    (De._renderSidebar = function (e) {
      var t = this.config,
        n = t.maxLevel,
        r = t.subMaxLevel,
        i = t.loadSidebar
    ...
    (De._bindEventOnRendered = function (e) {
      ...
      if (
        ...
        r &&
          'H1' !== r.tagName &&
          x(n, k('div', this.compiler.header(e.innerText, 1)).children[0])
      }
    }),
    (De._renderNav = function (e) {
      e && this._renderTo('nav', this.compiler.compile(e)),
        this.config.loadNavbar && z(this.router, 'nav')
    }),
    (De._renderMain = function (r, i, a) {
      var s = this
      if ((void 0 === i && (i = {}), !r)) return Te.call(this, r)
      R(this, 'beforeEach', r, function (e) {
        function t() {
          i.updatedAt && (n = Le(n, i.updatedAt, s.config.formatUpdated)),
            R(s, 'afterEach', n, function (e) {
              return Te.call(s, e)
            })
        }
        var n
        s.isHTML
          ? ((n = s.result = r), t(), a())
          : $e({ compiler: s.compiler, raw: e }, function (e) {
              ;(n = s.compiler.compile(e)), t(), a()
            })
      })
    }),
    (De._renderCover = function (e, t) {
      var n = m('.cover')
      if ((A(m('main'), t ? 'add' : 'remove', 'hidden'), e)) {
        ...
        if (i) {
          if ('color' === i[2]) n.style.background = i[1] + (i[3] || '')
            ...
            var a = i[1]
            A(n, 'add', 'has-mask'),
              H(i[1]) || (a = D(this.router.getBasePath(), i[1])),
        ...
        this._renderTo('.cover-main', r), P()
      } else A(n, 'remove', 'show')
    }),
    (De._updateRender = function () {
      !(function (e) {
    ...
    ((Ue = We)._loadSideAndNav = function (e, t, n, r) {
      var i = this
      return function () {
        if (!n) return r()
        Ie(
    ...
    (Ue._fetchCover = function () {
      ...
      if (n) {
        ...
        return (
          s
            ? ((s = this.router.getFile(a + s)),
              (this.coverIsHTML = /\.html$/g.test(s)),
              L(s + q(i, ['id']), !1, r).then(function (e) {
    ...
    (Ue._fetchFallbackPage = function (n, r, i) {
      var a = this
      void 0 === i && (i = h)
      var e = this.config,
        t = e.requestHeaders,
    ...
    (Ue._fetch404 = function (e, t, n) {
      ...
      if (o) {
        ...
        return (
          Ge(this.router.getFile(c), 0, s).then(
            function (e, t) {
    ...
    (We.$resetEvents = function (e) {
      var t = this,
        n = this.config.auto2top
      'history' !== e &&
        (t.route.query.id && ie(t.route.path, t.route.query.id),
        'navigate' === e &&
          n &&
          (function (e) {
            void 0 === e && (e = 0), (ae.scrollTop = !0 === e ? 0 : Number(e))
          })(n)),
        this.config.loadNavbar && z(this.router, 'nav')
    }),
    (window.Docsify = {
