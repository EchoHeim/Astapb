    ...
    function n(e) {
      function r() {
        ...
        var m = E.zoomedHd || E.original,
          c = L(m) ? t : m.naturalWidth || t,
          l = L(m) ? o : m.naturalHeight || o,
          ...
          if (E.zoomed) t(f)
            ...
            if (
              (E.original.dispatchEvent(
                g('medium-zoom:open', { detail: { zoom: f } })
              ),
              (u =
                window.pageYOffset ||
            ...
            if (
              ...
              E.zoomed.addEventListener('transitionend', function e() {
                ;(l = !1),
                  ...
                  E.original.dispatchEvent(
                    g('medium-zoom:opened', { detail: { zoom: f } })
                  ),
                  t(f)
              }),
              ...
              ;(E.zoomedHd = E.zoomed.cloneNode()),
                ...
                (E.zoomedHd.onerror = function () {
                  clearInterval(n),
                    console.warn(
                      'Unable to reach the zoom image target ' + E.zoomedHd.src
                    ),
                    (E.zoomedHd = null),
                    r()
                })
              ...
              var i = E.zoomedHd.addEventListener('load', function () {
                E.zoomedHd.removeEventListener('load', i),
                  E.zoomedHd.classList.add('medium-zoom-image--opened'),
                  E.zoomedHd.addEventListener('click', m),
                  document.body.appendChild(E.zoomedHd),
                  r()
        ...
        return new a(function (t) {
          if (!l && E.original) {
            ;(l = !0),
              ...
              E.original.dispatchEvent(
                g('medium-zoom:close', { detail: { zoom: f } })
              ),
              E.zoomed.addEventListener('transitionend', function e() {
                E.original.classList.remove('medium-zoom-image--hidden'),
                  ...
                  E.zoomed.removeEventListener('transitionend', e),
                  E.original.dispatchEvent(
                    g('medium-zoom:closed', { detail: { zoom: f } })
                  ),
                  (E.original = null),
                  (E.zoomed = null),
                  (E.zoomedHd = null),
      ...
      update: function (e) {
        ...
        if (
          ...
          t.container &&
            ...
            (o.container = H({}, b.container, t.container)),
          t.template)
        ) {
          var n = w(t.template)
            ? t.template
        ...
        return (
          i.forEach(function (e) {
            e.classList.remove('medium-zoom-image'),
              e.dispatchEvent(g('medium-zoom:detach', { detail: { zoom: f } }))
          }),
