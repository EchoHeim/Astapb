  ...
  ;(t.prototype = {
              ...
              for (var o = -2; 2 >= o; o++)
                for (var a = -2; 2 >= a; a++)
                  -2 == o || 2 == o || -2 == a || 2 == a || (0 == o && 0 == a)
                    ? (this.modules[i + o][n + a] = !0)
                    : (this.modules[i + o][n + a] = !1)
          }
      },
    ...
    (e.createData = function (t, r, o) {
      ...
      if (s.getLengthInBits() > 8 * u)
        throw new Error(
          'code length overflow. (' + s.getLengthInBits() + '>' + 8 * u + ')'
        )
      for (
  ...
  ;(r.prototype = {
    ...
    (i.getRSBlocks = function (t, e) {
      ...
      for (var n = r.length / 3, o = [], a = 0; n > a; a++)
        for (
          var s = r[3 * a + 0], h = r[3 * a + 1], l = r[3 * a + 2], u = 0;
          s > u;
          u++
        )
          o.push(new i(h, l))
      ...
      return (
        (t.prototype.draw = function (t) {
          ...
          o.setAttributeNS(
            ...
            i.appendChild(o),
            o.appendChild(
              e('rect', { fill: r.colorLight, width: '100%', height: '100%' })
            ),
            o.appendChild(
              e('rect', {
                fill: r.colorDark,
              ...
              for (var l = 0; n > l; l++)
                for (var u = 0; n > u; u++) {
                  ...
                  ;(r.strokeStyle = c ? i.colorDark : i.colorLight),
                    ...
                    r.strokeRect(Math.ceil(d) - 0.5, Math.ceil(f) - 0.5, s, h)
                }
              this._bIsPainted = !0
            }),
  ...
  (function (t, e, r) {
    ...
    function n(t, e) {
      ...
      v(i ? r.reverse() : r, function (r) {
        var n = s(r, e),
          o = e.initialized
            ? d(t, 'icon-' + r)
            : f('<a class="social-share-icon icon-' + r + '"></a>')
        return o.length
          ? ((o[0].href = n),
            'wechat' === r ? (o[0].tabindex = -1) : (o[0].target = '_blank'),
            void (
              e.initialized ||
              (i ? t.insertBefore(o[0], t.firstChild) : t.appendChild(o[0]))
            ))
          : !0
      })
    }
    ...
    function s(t, e) {
      return (
        ...
        B[t].replace(/\{\{(\w)(\w*)\}\}/g, function (i, n, o) {
    ...
    function p(t) {
      ...
      return t.hasAttributes()
        ? (v(t.attributes, function (t) {
            var r = t.name
            return 0 !== r.indexOf('data-')
              ? !0
              : ((r = r
                  .replace(/^data-/i, '')
