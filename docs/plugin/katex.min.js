    ...
    function (e, t, r) {
      ...
      var p = (function () {
        ...
        n = function e(t, r) {
          ...
          if (a && a.start <= a.end) {
            ...
            i +=
              (15 < n ? '\u2026' + o.slice(n - 15, n) : o.slice(0, n)) +
              l +
        ...
        h = (function () {
          function e(e) {
            ;(this.displayMode = void 0),
              ...
              (e = e || {}),
              (this.displayMode = Y.deflt(e.displayMode, !1)),
              (this.throwOnError = Y.deflt(e.throwOnError, !0)),
              (this.errorColor = Y.deflt(e.errorColor, '#cc0000')),
              (this.macros = e.macros || {}),
              (this.colorIsTextColor = Y.deflt(e.colorIsTextColor, !1)),
              (this.strict = Y.deflt(e.strict, 'warn')),
              (this.maxSize = Math.max(0, Y.deflt(e.maxSize, 1 / 0))),
              (this.maxExpand = Math.max(0, Y.deflt(e.maxExpand, 1e3))),
              (this.allowedProtocols = Y.deflt(e.allowedProtocols, [
                'http',
                'https',
                'mailto',
                '_relative',
      ...
      var k = {
        ...
        M = function (e) {
          ...
          for (var r in ((t.className = S(this.classes)), this.style))
        ...
        B = function (e) {
          var t = '<' + e
          this.classes.length &&
            (t += ' class="' + Y.escape(S(this.classes)) + '"')
          var r = ''
          for (var n in this.style)
            this.style.hasOwnProperty(n) &&
              (r += Y.hyphenate(n) + ':' + this.style[n] + ';')
          for (var i in (r && (t += ' style="' + Y.escape(r) + '"'),
          this.attributes))
        ...
        O = (function () {
          function e(e, t, r, n, i, a, o, s) {
            ...
            l && this.classes.push(l + '_fallback'),
              /[\xee\xef\xed\xec]/.test(this.text) && (this.text = E[this.text])
          }
          var t = e.prototype
          return (
            (t.hasClass = function (e) {
            ...
            (t.toNode = function () {
              var e = document.createTextNode(this.text),
                t = null
              for (var r in (0 < this.italic &&
                ((t = document.createElement('span')).style.marginRight =
                  this.italic + 'em'),
              0 < this.classes.length &&
                ((t = t || document.createElement('span')).className = S(
                  this.classes
                )),
              this.style))
            ...
            (t.toMarkup = function () {
              ...
              this.classes.length &&
                ((e = !0),
                (t += ' class="'),
                (t += Y.escape(S(this.classes))),
                (t += '"'))
              var r = ''
              for (var n in (0 < this.italic &&
            ...
            (t.toNode = function () {
              ...
              return (
                this.alternate
                  ...
                  : e.setAttribute('d', k.path[this.pathName]),
                e
              )
            }),
            (t.toMarkup = function () {
      ...
      function j(e, t, r, n, i, a) {
        ;(_[e][i] = { font: t, group: r, replace: n }),
          a && n && (_[e][n] = _[e][i])
      }
      var $ = 'math',
        Z = 'text',
      ...
      j($, K, se, '\u2261', '\\equiv', !0),
        ...
        j($, K, ee, '\u2a3f', '\\amalg'),
        j($, K, ee, '&', '\\And'),
        j($, K, se, '\u27f5', '\\longleftarrow', !0),
        j($, K, se, '\u21d0', '\\Leftarrow', !0),
        j($, K, se, '\u27f8', '\\Longleftarrow', !0),
        j($, K, se, '\u27f6', '\\longrightarrow', !0),
        j($, K, se, '\u21d2', '\\Rightarrow', !0),
        j($, K, se, '\u27f9', '\\Longrightarrow', !0),
        j($, K, se, '\u2194', '\\leftrightarrow', !0),
        j($, K, se, '\u27f7', '\\longleftrightarrow', !0),
        j($, K, se, '\u21d4', '\\Leftrightarrow', !0),
        j($, K, se, '\u27fa', '\\Longleftrightarrow', !0),
        j($, K, se, '\u21a6', '\\mapsto', !0),
        j($, K, se, '\u27fc', '\\longmapsto', !0),
        j($, K, se, '\u2197', '\\nearrow', !0),
        j($, K, se, '\u21a9', '\\hookleftarrow', !0),
        j($, K, se, '\u21aa', '\\hookrightarrow', !0),
        j($, K, se, '\u2198', '\\searrow', !0),
        j($, K, se, '\u21bc', '\\leftharpoonup', !0),
        j($, K, se, '\u21c0', '\\rightharpoonup', !0),
        j($, K, se, '\u2199', '\\swarrow', !0),
        j($, K, se, '\u21bd', '\\leftharpoondown', !0),
        j($, K, se, '\u21c1', '\\rightharpoondown', !0),
        j($, K, se, '\u2196', '\\nwarrow', !0),
        j($, K, se, '\u21cc', '\\rightleftharpoons', !0),
        j($, J, se, '\u226e', '\\nless', !0),
        j($, J, se, '\ue010', '\\nleqslant'),
        j($, J, se, '\ue011', '\\nleqq'),
        j($, J, se, '\u2a87', '\\lneq', !0),
        ...
        j($, J, he, '\u24c8', '\\circledS'),
        j($, J, he, '\xae', '\\circledR'),
        j(Z, J, he, '\xae', '\\circledR'),
        j($, J, he, '\u2221', '\\measuredangle', !0),
        j($, J, he, '\u2204', '\\nexists'),
        j($, J, he, '\u2127', '\\mho'),
        j($, J, he, '\u2132', '\\Finv', !0),
        j($, J, he, '\u2141', '\\Game', !0),
        j($, J, he, 'k', '\\Bbbk'),
        j($, J, he, '\u2035', '\\backprime'),
        j($, J, he, '\u25b2', '\\blacktriangle'),
        j($, J, he, '\u25bc', '\\blacktriangledown'),
        j($, J, he, '\u25a0', '\\blacksquare'),
        j($, J, he, '\u29eb', '\\blacklozenge'),
        j($, J, he, '\u2605', '\\bigstar'),
        j($, J, he, '\u2222', '\\sphericalangle', !0),
        j($, J, he, '\u2201', '\\complement', !0),
        j($, J, he, '\xf0', '\\eth', !0),
        j($, J, he, '\u2571', '\\diagup'),
        j($, J, he, '\u2572', '\\diagdown'),
        ...
        j($, J, se, '\u2a8b', '\\lesseqqgtr', !0),
        j($, J, se, '\u2251', '\\doteqdot'),
        j($, J, se, '\u2253', '\\risingdotseq', !0),
        j($, J, se, '\u2252', '\\fallingdotseq', !0),
        j($, J, se, '\u223d', '\\backsim', !0),
        j($, J, se, '\u22cd', '\\backsimeq', !0),
        j($, J, se, '\u2ac5', '\\subseteqq', !0),
        j($, J, se, '\u22d0', '\\Subset', !0),
        j($, J, se, '\u228f', '\\sqsubset', !0),
        j($, J, se, '\u227c', '\\preccurlyeq', !0),
        j($, J, se, '\u22de', '\\curlyeqprec', !0),
        j($, J, se, '\u227e', '\\precsim', !0),
        j($, J, se, '\u2ab7', '\\precapprox', !0),
        j($, J, se, '\u22b2', '\\vartriangleleft'),
        j($, J, se, '\u22b4', '\\trianglelefteq'),
        j($, J, se, '\u22a8', '\\vDash', !0),
        j($, J, se, '\u22aa', '\\Vvdash', !0),
        j($, J, se, '\u2323', '\\smallsmile'),
        j($, J, se, '\u2322', '\\smallfrown'),
        ...
        j($, J, se, '\u22d1', '\\Supset', !0),
        j($, J, se, '\u2290', '\\sqsupset', !0),
        j($, J, se, '\u227d', '\\succcurlyeq', !0),
        j($, J, se, '\u22df', '\\curlyeqsucc', !0),
        j($, J, se, '\u227f', '\\succsim', !0),
        j($, J, se, '\u2ab8', '\\succapprox', !0),
        j($, J, se, '\u22b3', '\\vartriangleright'),
        j($, J, se, '\u22b5', '\\trianglerighteq'),
        j($, J, se, '\u22a9', '\\Vdash', !0),
        j($, J, se, '\u2223', '\\shortmid'),
        j($, J, se, '\u2225', '\\shortparallel'),
        j($, J, se, '\u226c', '\\between', !0),
        j($, J, se, '\u22d4', '\\pitchfork', !0),
        j($, J, se, '\u221d', '\\varpropto'),
        j($, J, se, '\u25c0', '\\blacktriangleleft'),
        j($, J, se, '\u2234', '\\therefore', !0),
        j($, J, se, '\u220d', '\\backepsilon'),
        j($, J, se, '\u25b6', '\\blacktriangleright'),
        j($, J, se, '\u2235', '\\because', !0),
        j($, J, se, '\u22d8', '\\llless'),
        j($, J, se, '\u22d9', '\\gggtr'),
        j($, J, ee, '\u22b2', '\\lhd'),
        ...
        j($, J, se, '\u2251', '\\Doteq', !0),
        j($, J, ee, '\u2214', '\\dotplus', !0),
        j($, J, ee, '\u2216', '\\smallsetminus'),
        j($, J, ee, '\u22d2', '\\Cap', !0),
        j($, J, ee, '\u22d3', '\\Cup', !0),
        j($, J, ee, '\u2a5e', '\\doublebarwedge', !0),
        j($, J, ee, '\u229f', '\\boxminus', !0),
        j($, J, ee, '\u229e', '\\boxplus', !0),
        j($, J, ee, '\u22c7', '\\divideontimes', !0),
        j($, J, ee, '\u22c9', '\\ltimes', !0),
        j($, J, ee, '\u22ca', '\\rtimes', !0),
        j($, J, ee, '\u22cb', '\\leftthreetimes', !0),
        j($, J, ee, '\u22cc', '\\rightthreetimes', !0),
        j($, J, ee, '\u22cf', '\\curlywedge', !0),
        j($, J, ee, '\u22ce', '\\curlyvee', !0),
        j($, J, ee, '\u229d', '\\circleddash', !0),
        j($, J, ee, '\u229b', '\\circledast', !0),
        j($, J, ee, '\u22c5', '\\centerdot'),
        j($, J, ee, '\u22ba', '\\intercal', !0),
        j($, J, ee, '\u22d2', '\\doublecap'),
        j($, J, ee, '\u22d3', '\\doublecup'),
        j($, J, ee, '\u22a0', '\\boxtimes', !0),
        j($, J, se, '\u21e2', '\\dashrightarrow', !0),
        j($, J, se, '\u21e0', '\\dashleftarrow', !0),
        j($, J, se, '\u21c7', '\\leftleftarrows', !0),
        j($, J, se, '\u21c6', '\\leftrightarrows', !0),
        j($, J, se, '\u21da', '\\Lleftarrow', !0),
        j($, J, se, '\u219e', '\\twoheadleftarrow', !0),
        j($, J, se, '\u21a2', '\\leftarrowtail', !0),
        j($, J, se, '\u21ab', '\\looparrowleft', !0),
        j($, J, se, '\u21cb', '\\leftrightharpoons', !0),
        j($, J, se, '\u21b6', '\\curvearrowleft', !0),
        j($, J, se, '\u21ba', '\\circlearrowleft', !0),
        j($, J, se, '\u21b0', '\\Lsh', !0),
        j($, J, se, '\u21c8', '\\upuparrows', !0),
        j($, J, se, '\u21bf', '\\upharpoonleft', !0),
        j($, J, se, '\u21c3', '\\downharpoonleft', !0),
        j($, J, se, '\u22b8', '\\multimap', !0),
        j($, J, se, '\u21ad', '\\leftrightsquigarrow', !0),
        j($, J, se, '\u21c9', '\\rightrightarrows', !0),
        j($, J, se, '\u21c4', '\\rightleftarrows', !0),
        j($, J, se, '\u21a0', '\\twoheadrightarrow', !0),
        j($, J, se, '\u21a3', '\\rightarrowtail', !0),
        j($, J, se, '\u21ac', '\\looparrowright', !0),
        j($, J, se, '\u21b7', '\\curvearrowright', !0),
        j($, J, se, '\u21bb', '\\circlearrowright', !0),
        j($, J, se, '\u21b1', '\\Rsh', !0),
        j($, J, se, '\u21ca', '\\downdownarrows', !0),
        j($, J, se, '\u21be', '\\upharpoonright', !0),
        j($, J, se, '\u21c2', '\\downharpoonright', !0),
        j($, J, se, '\u21dd', '\\rightsquigarrow', !0),
        j($, J, se, '\u21dd', '\\leadsto'),
        j($, J, se, '\u21db', '\\Rrightarrow', !0),
        j($, J, se, '\u21be', '\\restriction'),
        j($, K, he, '\u2018', '`'),
        j($, K, he, '$', '\\$'),
        j(Z, K, he, '$', '\\$'),
        ...
        j($, K, he, '\u2202', '\\partial', !0),
        j($, K, ee, '\u2298', '\\oslash', !0),
        j($, J, ee, '\u229a', '\\circledcirc', !0),
        j($, J, ee, '\u22a1', '\\boxdot', !0),
        j($, K, ee, '\u25b3', '\\bigtriangleup'),
        j($, K, ee, '\u25bd', '\\bigtriangledown'),
        j($, K, ee, '\u2020', '\\dagger'),
        j($, K, ee, '\u22c4', '\\diamond'),
        j($, K, ee, '\u22c6', '\\star'),
        j($, K, ee, '\u25c3', '\\triangleleft'),
        ...
        j($, K, ae, '{', '\\{'),
        j(Z, K, he, '{', '\\{'),
        j(Z, K, he, '{', '\\textbraceleft'),
        j($, K, te, '}', '\\}'),
        j(Z, K, he, '}', '\\}'),
        j(Z, K, he, '}', '\\textbraceright'),
        j($, K, ae, '{', '\\lbrace'),
        j($, K, te, '}', '\\rbrace'),
        j($, K, ae, '[', '\\lbrack'),
        j(Z, K, he, '[', '\\lbrack'),
        ...
        j($, K, he, '\u2225', '\\Vert'),
        j(Z, K, he, '\u2225', '\\textbardbl'),
        j(Z, K, he, '~', '\\textasciitilde'),
        j($, K, se, '\u2191', '\\uparrow', !0),
        j($, K, se, '\u21d1', '\\Uparrow', !0),
        j($, K, se, '\u2193', '\\downarrow', !0),
        j($, K, se, '\u21d3', '\\Downarrow', !0),
        j($, K, se, '\u2195', '\\updownarrow', !0),
        j($, K, se, '\u21d5', '\\Updownarrow', !0),
        j($, K, ie, '\u2210', '\\coprod'),
        j($, K, ie, '\u22c1', '\\bigvee'),
        j($, K, ie, '\u22c0', '\\bigwedge'),
      ...
      j(Z, K, he, '\u2013', '--'),
        ...
        j(Z, K, he, '\u2014', '\\textemdash'),
        j(Z, K, he, '\u2018', '`'),
        j(Z, K, he, '\u2018', '\\textquoteleft'),
        j(Z, K, he, '\u2019', "'"),
        j(Z, K, he, '\u2019', '\\textquoteright'),
        j(Z, K, he, '\u201c', '``'),
        j(Z, K, he, '\u201c', '\\textquotedblleft'),
        j(Z, K, he, '\u201d', "''"),
        j(Z, K, he, '\u201d', '\\textquotedblright'),
        j($, K, he, '\xb0', '\\degree', !0),
        j(Z, K, he, '\xb0', '\\degree'),
        j(Z, K, he, '\xb0', '\\textdegree', !0),
        j($, K, ne, '\xa3', '\\pounds'),
        j($, K, ne, '\xa3', '\\mathsterling', !0),
        j(Z, K, ne, '\xa3', '\\pounds'),
        j(Z, K, ne, '\xa3', '\\textsterling', !0),
        j($, J, he, '\u2720', '\\maltese'),
        j(Z, J, he, '\u2720', '\\maltese'),
        j(Z, K, le, '\xa0', '\\ '),
        j(Z, K, le, '\xa0', ' '),
      ...
      for (
        var ve = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz', ye = 0;
        ye < ve.length;
        ye++
      ) {
        var be = ve.charAt(ye)
      ...
      for (var xe = '', we = 0; we < ve.length; we++) {
        var ke = ve.charAt(we)
        j($, K, ne, ke, (xe = String.fromCharCode(55349, 56320 + we))),
          j(Z, K, he, ke, xe),
          j($, K, ne, ke, (xe = String.fromCharCode(55349, 56372 + we))),
          j(Z, K, he, ke, xe),
          j($, K, ne, ke, (xe = String.fromCharCode(55349, 56424 + we))),
          j(Z, K, he, ke, xe),
          j($, K, ne, ke, (xe = String.fromCharCode(55349, 56580 + we))),
          j(Z, K, he, ke, xe),
          j($, K, ne, ke, (xe = String.fromCharCode(55349, 56736 + we))),
          j(Z, K, he, ke, xe),
          j($, K, ne, ke, (xe = String.fromCharCode(55349, 56788 + we))),
          j(Z, K, he, ke, xe),
          j($, K, ne, ke, (xe = String.fromCharCode(55349, 56840 + we))),
          j(Z, K, he, ke, xe),
          j($, K, ne, ke, (xe = String.fromCharCode(55349, 56944 + we))),
          j(Z, K, he, ke, xe),
          we < 26 &&
            (j($, K, ne, ke, (xe = String.fromCharCode(55349, 56632 + we))),
            j(Z, K, he, ke, xe),
            j($, K, ne, ke, (xe = String.fromCharCode(55349, 56476 + we))),
            j(Z, K, he, ke, xe))
      }
      j($, K, ne, 'k', (xe = String.fromCharCode(55349, 56668))),
        j(Z, K, he, 'k', xe)
      for (var Se = 0; Se < 10; Se++) {
        var ze = Se.toString()
        j($, K, ne, ze, (xe = String.fromCharCode(55349, 57294 + Se))),
          j(Z, K, he, ze, xe),
          j($, K, ne, ze, (xe = String.fromCharCode(55349, 57314 + Se))),
          j(Z, K, he, ze, xe),
          j($, K, ne, ze, (xe = String.fromCharCode(55349, 57324 + Se))),
          j(Z, K, he, ze, xe),
          j($, K, ne, ze, (xe = String.fromCharCode(55349, 57334 + Se))),
          j(Z, K, he, ze, xe)
      }
        ...
        Oe = (function () {
          ...
          return (
            ...
            (e.havingStyle = function (e) {
              return this.style === e
                ? this
                : this.extend({ style: e, size: Ee(this.textSize, e) })
            }),
                ...
                this._fontMetrics ||
                  (this._fontMetrics = (function (e) {
                    ...
                    if (!V[(t = 5 <= e ? 0 : 3 <= e ? 1 : 2)]) {
                      var r = (V[t] = { cssEmPerMu: D.quad[t] / 18 })
                      for (var n in D) D.hasOwnProperty(n) && (r[n] = D[n][t])
                    }
                    return V[t]
                  })(this.size)),
                this._fontMetrics
            ...
            (e.getColor = function () {
              return this.phantom
                ? 'transparent'
                : null != this.color && n.colorMap.hasOwnProperty(this.color)
                ? n.colorMap[this.color]
                : this.color
            }),
            n
          )
      ...
      var Ie = Oe,
        ...
        He = function (e, t) {
          var r
          if (e.unit in Re)
            r = Re[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier
        ...
        Pe = function (e, t, r) {
          return (
            W[r][e] && W[r][e].replace && (e = W[r][e].replace),
            { value: e, metrics: F(e, t, r) }
          )
        },
        Fe = function (e, t, r, n, i) {
          var a,
            o = Pe(e, t, r),
            s = o.metrics
          if (((e = o.value), s)) {
            ...
            ;('text' === r || (n && 'mathit' === n.font)) && (l = 0),
              (a = new O(e, s.height, s.depth, l, s.skew, s.width, i))
          } else
            'undefined' != typeof console &&
              console.warn(
                "No character metrics for '" + e + "' in style '" + t + "'"
              ),
              (a = new O(e, 0, 0, 0, 0, 0, i))
          if (n) {
        ...
        $e = {
          ...
          wrapFragment: function (e, t) {
            return e instanceof A ? Ge([], [e], t) : e
          },
          makeVList: function (e, t) {
              ...
              var r = (function (e) {
                  if ('individualShift' === e.positionType) {
                    for (
                      ...
                      ;(i += o), r.push({ type: 'kern', size: s }), r.push(t[a])
                    }
            ...
            if (((w.style.height = u + 'em'), c < 0)) {
              var k = Ge([], []),
                S = Ge(['vlist'], [k])
              S.style.height = -c + 'em'
              var z = Ge(['vlist-s'], [new O('\u200b')])
              x = [Ge(['vlist-r'], [w, z]), Ge(['vlist-r'], [S])]
            } else x = [Ge(['vlist-r'], [w])]
            var M = Ge(['vlist-t'], x)
            return (
              2 === x.length && M.classes.push('vlist-t2'),
              (M.height = u),
              (M.depth = -c),
              M
            )
          ...
          makeOrd: function (e, t, r) {
            ...
            if (l) {
              ...
              if ('boldsymbol' === l || 'mathnormal' === l) {
                var d =
                  'boldsymbol' === l
                    ? Pe(a, 'Math-BoldItalic', i).metrics
                ...
                p = Y.contains(De, a)
                  ? ((u = 'Main-Italic'), ['mathit'])
                  : s
                  ? ((u = We[l].fontName), [l])
                  : ((u = _e(l, t.fontWeight, t.fontShape)),
                    [l, t.fontWeight, t.fontShape])
              if (Pe(a, u, i).metrics) return Fe(a, u, i, t, o.concat(p))
              if (me.hasOwnProperty(a) && 'Typewriter' === u.substr(0, 10)) {
                for (var f = [], g = 0; g < a.length; g++)
                  f.push(Fe(a[g], u, i, t, o.concat(p)))
                return Ye(f)
              }
            }
            if ('mathord' === r) {
              var v =
                /[0-9]/.test((w = a).charAt(0)) || Y.contains(De, w)
                  ? { fontName: 'Main-Italic', fontClass: 'mathit' }
                  : { fontName: 'Math-Italic', fontClass: 'mathdefault' }
              return Fe(a, v.fontName, i, t, o.concat([v.fontClass]))
            }
            if ('textord' !== r)
              throw new Error('unexpected type: ' + r + ' in makeOrd')
            var y = W[i][a] && W[i][a].font
            if ('ams' === y) {
              var b = _e('amsrm', t.fontWeight, t.fontShape)
              return Fe(
                a,
                b,
                i,
            ...
            if ('main' !== y && y) {
              var x = _e(y, t.fontWeight, t.fontShape)
              return Fe(a, x, i, t, o.concat(x, t.fontWeight, t.fontShape))
            }
            var w,
              k = _e('textrm', t.fontWeight, t.fontShape)
            return Fe(a, k, i, t, o.concat(t.fontWeight, t.fontShape))
          },
      ...
      function Je(e, t) {
        var r,
          n,
          i =
            ((n = t), (r = e) && 'atom' === r.type && r.family === n ? r : null)
        if (!i)
          throw new Error(
      ...
      var mt = function (e) {
        ...
        dt = function (e, t, r, n) {
          ...
          for (
            ...
            'mbin' === g.classes[0] &&
              ...
              (h = r),
              l
                ? Y.contains(['mrel', 'mclose', 'mpunct'], gt(l, 'left'))
                : h) &&
              (g.classes[0] = 'mord')
          }
          for (var v = [], y = 0, b = 0; b < i.length; b++)
            if (
              (v.push(i[b]), 'mspace' !== i[b].classes[0] && y < u.length - 1)
            ) {
              0 === y && (v.pop(), b--)
              var x = gt(u[y], 'right'),
                w = gt(u[y + 1], 'left')
              if (x && w && r) {
                var k = T(u[y + 1]),
                  S = vt(k) ? it[x][w] : nt[x][w]
                if (S) {
                  var z = t
                  if (1 === e.length) {
                    var M = Ke(e[0], 'sizing') || Ke(e[0], 'styling')
                    M &&
                      ('sizing' === M.type
                        ? (z = t.havingSize(M.size))
                        : 'styling' === M.type &&
                          (z = t.havingStyle(ut[M.style])))
                  }
                  v.push($e.makeGlue(S, z))
                }
              }
              y++
            }
        ...
        ft = function e(t, r) {
          if (t instanceof A || t instanceof N) {
            var n = t.children
            if (n.length) {
        ...
        gt = function (e, t) {
          return e ? ((e = ft(e, t)), pt[e.classes[0]] || null) : null
        },
        vt = function (e) {
          return (e = ft(e, 'left')).hasClass('mtight')
        },
        yt = function (e, t) {
      ...
      function wt(e, t) {
        ...
        for (var n, i = dt(e, t, !0), a = [], o = [], s = 0; s < i.length; s++)
          if (
            (o.push(i[s]),
            i[s].hasClass('mbin') ||
              i[s].hasClass('mrel') ||
            ...
            i[s].hasClass('newline') &&
              (o.pop(),
              0 < o.length && (a.push(xt(o, t)), (o = [])),
              a.push(i[s]))
        0 < o.length && a.push(xt(o, t)),
          r && (((n = xt(dt(r, t, !0))).classes = ['tag']), a.push(n))
        var h = ct(['katex-html'], a)
      ...
      var St = (function () {
        ...
        Bt = function (e, t) {
          ...
          var i = e.text
          return Y.contains(['\\imath', '\\jmath'], i)
            ? null
            : (W[n][i] && W[n][i].replace && (i = W[n][i].replace),
              F(i, $e.fontMap[r].fontName, n) ? $e.fontMap[r].variant : null)
        },
        Ct = function (e, t) {
          for (var r, n = [], i = 0; i < e.length; i++) {
            var a = qt(e[i], t)
            if (a instanceof St && r instanceof St) {
              if (
                'mtext' === a.type &&
                'mtext' === r.type &&
                a.getAttribute('mathvariant') === r.getAttribute('mathvariant')
              ) {
                var o
      ...
      var Et = function (e) {
          ...
          var n = Et(r),
            i = (function (e, t, r) {
              ...
              n =
                1 === i.length &&
                i[0] instanceof St &&
                Y.contains(['mrow', 'mtable'], i[0].type)
                  ? i[0]
                  : new Mt.MathNode('mrow', i)
              var a = new Mt.MathNode('annotation', [new Mt.TextNode(t)])
              a.setAttribute('encoding', 'application/x-tex')
              var o = new Mt.MathNode('semantics', [n, a]),
                s = new Mt.MathNode('math', [o])
              return $e.makeSpan(['katex-mathml'], [s])
            })(e, t, n),
            a = wt(e, n),
            o = $e.makeSpan(['katex'], [i, a])
          return r.displayMode ? $e.makeSpan(['katex-display'], [o]) : o
        },
        It = {
          widehat: '^',
          widecheck: '\u02c7',
        ...
        Lt = function (e, t, r, n) {
          ...
          if (/fbox|color/.test(t)) {
            ...
            var l = new I(s, { width: '100%', height: a + 'em' })
            i = $e.makeSvgSpan([], [l], n)
          }
          return (i.height = a), (i.style.height = a + 'em'), i
        },
        Ht = function (e) {
          var t = new Mt.MathNode('mo', [new Mt.TextNode(It[e.substr(1)])])
        ...
        Dt = function (S, z) {
          var e = (function () {
              var e = 4e5,
                t = S.label.substr(1)
              if (
                Y.contains(['widehat', 'widecheck', 'widetilde', 'utilde'], t)
              ) {
                var r,
                  n,
                  i,
                ...
                if (5 < a)
                  n =
                    'widehat' === t || 'widecheck' === t
                      ? ((r = 420), (e = 2364), (i = 0.42), t + '4')
                      : ((r = 312), (e = 2340), (i = 0.34), 'tilde4')
                else {
                  var o = [1, 1, 2, 2, 3, 3][a]
                  n =
                    'widehat' === t || 'widecheck' === t
                      ? ((e = [0, 1062, 2364, 2364, 2364][o]),
                        (r = [0, 239, 300, 360, 420][o]),
                        (i = [0, 0.24, 0.3, 0.3, 0.36, 0.42][o]),
                        t + o)
                      : ((e = [0, 600, 1033, 2339, 2340][o]),
                        (r = [0, 260, 286, 306, 312][o]),
                        (i = [0, 0.26, 0.286, 0.3, 0.306, 0.34][o]),
                        'tilde' + o)
                }
                var s = new R(n),
                  l = new I([s], {
              ...
              for (var b = 0; b < y; b++) {
                var x = new R(d[b]),
                  ...
                  k = $e.makeSvgSpan([h[b]], [w], z)
                if (1 === y) return { span: k, minWidth: f, height: v }
                ;(k.style.height = v + 'em'), u.push(k)
              }
              return {
                span: $e.makeSpan(['stretchy'], u, z),
                minWidth: f,
                height: v,
              }
            })(),
        ...
        Pt = function (e, t) {
          ...
          a
            ? ((r = (n = Ze(a.base, 'accent')).base),
              ...
              (a.base = n))
            : (r = (n = Ze(e, 'accent')).base)
          var o = bt(r, t.havingCrampedStyle()),
            s = 0
          if (n.isShifty && Y.isCharacterBox(r)) {
            ...
            })(bt(l, t.havingCrampedStyle())).skew
          }
          var h,
          ...
          if (n.isStretchy)
            ...
            ;(u =
              '\\vec' === n.label
                ? ((c = $e.staticSvg('vec', t)), $e.svgData.vec[1])
                : (((c = $e.makeSymbol(
                    n.label,
                    'Main-Regular',
                    n.mode,
        ...
        Ft = function (e, t) {
          var r = e.isStretchy
              ? Ht(e.label)
              : new Mt.MathNode('mo', [Tt(e.label, e.mode)]),
        ...
        lt({
          ...
          htmlBuilder: function (e, t) {
            var r,
              ...
              a = $e.wrapFragment(bt(e.body, i, t), t)
            a.classes.push('x-arrow-pad'),
              e.below &&
                ((i = t.havingStyle(n.sub())),
                (r = $e.wrapFragment(bt(e.below, i, t), t)).classes.push(
                  'x-arrow-pad'
                ))
            var o,
              s = Dt(e, t),
              l = -t.fontMetrics().axisHeight + 0.5 * s.height,
              h = -t.fontMetrics().axisHeight - 0.5 * s.height - 0.111
            if (
              ((0.25 < a.depth || '\\xleftequilibrium' === e.label) &&
                (h -= a.depth),
              r)
            ) {
              var m =
                -t.fontMetrics().axisHeight + r.height + 0.5 * s.height + 0.111
              o = $e.makeVList(
                {
          ...
          mathmlBuilder: function (e, t) {
            ...
            if (e.body) {
              ...
              r = e.below
                ? ((n = qt(e.below, t)),
                  new Mt.MathNode('munderover', [i, n, a]))
                : new Mt.MathNode('mover', [i, a])
            } else
              r = e.below
                ? ((n = qt(e.below, t)), new Mt.MathNode('munder', [i, n]))
                : new Mt.MathNode('mover', [i])
            return r
          },
        }),
        lt({
          ...
          handler: function (e, t) {
            for (
              var r = e.parser, n = Ze(t[0], 'ordgroup').body, i = '', a = 0;
              a < n.length;
              a++
            ) {
              i += Ze(n[a], 'textord').text
            }
            var o = parseInt(i)
      ...
      lt({
        ...
        handler: function (e, t) {
          var r = e.parser,
            ...
            i = t[1]
          return { type: 'color', mode: r.mode, color: n, body: mt(i) }
        },
        htmlBuilder: Ut,
        mathmlBuilder: Gt,
      }),
        ...
        lt({
          ...
          htmlBuilder: function (e, t) {
            if (e.newRow)
              throw new X('\\cr valid only within a tabular/array environment')
            var r = $e.makeSpan(['mspace'], [], t)
            return (
              e.newLine &&
                (r.classes.push('newline'),
                e.size && (r.style.marginTop = He(e.size, t) + 'em')),
              r
            )
          },
          mathmlBuilder: function (e, t) {
            ...
            return (
              e.newLine &&
                ...
                e.size && r.setAttribute('height', He(e.size, t) + 'em')),
              r
            )
          },
        })
      var Xt = function (e, t, r) {
        ...
        Yt = function (e, t, r, n) {
          var i = r.havingBaseStyle(t),
            a = $e.makeSpan(n.concat(i.sizingClasses(r)), [e], r),
        ...
        Wt = function (e, t, r, n, i, a) {
          var o,
            ...
            m =
              ...
              (l = i),
              (h = n),
              $e.makeSymbol(o, 'Size' + s + '-Regular', l, h)),
            c = Yt(
              $e.makeSpan(['delimsizing', 'size' + t], [m], n),
              q.TEXT,
              n,
              a
            )
          return r && _t(c, n, q.TEXT), c
        },
        jt = function (e, t, r) {
          var n
          return (
            (n = 'Size1-Regular' === t ? 'delim-size1' : 'delim-size4'),
            {
              ...
              elem: $e.makeSpan(
                ['delimsizinginner', n],
                [$e.makeSpan([], [$e.makeSymbol(e, t, r)])]
              ),
            }
          )
        },
        $t = function (e, t, r, n, i, a) {
          var o, s, l, h
          ;(o = l = h = e), (s = null)
          var m = 'Size1-Regular'
          '\\uparrow' === e
          ...
          var z = k / 2 - S,
            M = []
          if ((M.push(jt(h, m, i)), null === s))
            for (var T = 0; T < w; T++) M.push(jt(l, m, i))
          else {
            for (var A = 0; A < w; A++) M.push(jt(l, m, i))
            M.push(jt(s, m, i))
            for (var B = 0; B < w; B++) M.push(jt(l, m, i))
          }
          M.push(jt(o, m, i))
          var C = n.havingBaseStyle(q.TEXT),
            N = $e.makeVList(
              { positionType: 'bottom', positionData: z, children: M },
              C
            )
          return Yt($e.makeSpan(['delimsizing', 'mult'], [N], C), q.TEXT, n, a)
        },
        Zt = function (e, t, r, n) {
          var i
          'sqrtTall' === e &&
        ...
        or = function (e, t, r, n, i, a) {
          var o
          '<' === e || '\\lt' === e || '\u27e8' === e
            ? (e = '\\langle')
            : ('>' !== e && '\\gt' !== e && '\u27e9' !== e) || (e = '\\rangle'),
            (o = Y.contains(Qt, e) ? tr : Y.contains(Kt, e) ? nr : rr)
          var s,
            l,
            h,
            m,
          ...
          return 'small' === f.type
            ? ((s = e),
              ...
              (c = i),
              (u = a),
              (p = $e.makeSymbol(s, 'Main-Regular', c, m)),
              (d = Yt(p, l, m, u)),
              h && _t(d, m, l),
              d)
            : 'large' === f.type
        ...
        sr = function (e, t) {
          var r,
            ...
            a = ar('\\surd', e * i.sizeMultiplier, nr, i),
            o = i.sizeMultiplier,
            s = 0,
            l = 0,
            h = 0
            ...
            (n =
              'small' === a.type
                ...
                ? ((h = 1080 * er[a.size]),
                  (l = er[a.size] / o),
                  (s = (er[a.size] + 0.08) / o),
                  ((r = Zt('sqrtSize' + a.size, s, h, t)).style.minWidth =
                    '1.02em'),
                  1 / o)
                : ((s = e + 0.08),
                  (l = e),
                  (h = Math.floor(1e3 * e) + 80),
                  ((r = Zt('sqrtTall', s, h, t)).style.minWidth = '0.742em'),
                  1.056)),
            (r.height = l),
            (r.style.height = s + 'em'),
            {
        ...
        lr = function (e, t, r, n, i) {
          if (
            ('<' === e || '\\lt' === e || '\u27e8' === e
              ? (e = '\\langle')
              : ('>' !== e && '\\gt' !== e && '\u27e9' !== e) ||
                (e = '\\rangle'),
            Y.contains(Kt, e) || Y.contains(Qt, e))
          )
            return Wt(e, t, !1, r, n, i)
          if (Y.contains(Jt, e)) return $t(e, er[t], !1, r, n, i)
          throw new X("Illegal delimiter: '" + e + "'")
        },
        hr = or,
        mr = function (e, t, r, n, i, a) {
          var o = n.fontMetrics().axisHeight * n.sizeMultiplier,
            s = 5 / n.fontMetrics().ptPerEm,
            l = Math.max(t - o, r + o),
            h = Math.max((l / 500) * 901, 2 * l - s)
          return or(e, h, !0, n, i, a)
        },
        cr = {
      ...
      function pr(e, t) {
        var r = Qe(e)
        if (r && Y.contains(ur, r.text)) return r
        throw new X(
          "Invalid delimiter: '" +
            (r ? r.text : JSON.stringify(e)) +
            "' after '" +
            t.funcName +
            "'",
          e
      ...
      lt({
        ...
        htmlBuilder: function (e, t) {
          return '.' === e.delim
            ? $e.makeSpan([e.mclass])
            : lr(e.delim, e.size, t, e.mode, [e.mclass])
        },
        ...
        lt({
          ...
          handler: function (e, t) {
            ...
            var a = Ze(n.parseFunction(), 'leftright-right')
            return {
              type: 'leftright',
              mode: n.mode,
              body: i,
          ...
          htmlBuilder: function (e, t) {
            ...
            if (
              ...
              (r =
                '.' === e.left
                  ? yt(t, ['mopen'])
                  : mr(e.left, a, o, t, e.mode, ['mopen'])),
              i.unshift(r),
              s)
            )
              for (var h = 1; h < i.length; h++) {
                var m = i[h].isMiddle
                m && (i[h] = mr(m.delim, a, o, m.options, e.mode, []))
              }
            return (
              (n =
                '.' === e.right
                  ? yt(t, ['mclose'])
                  : mr(e.right, a, o, t, e.mode, ['mclose'])),
              i.push(n),
              $e.makeSpan(['minner'], i, t)
            )
          },
          mathmlBuilder: function (e, t) {
            dr(e)
            var r = Ct(e.body, t)
            if ('.' !== e.left) {
              var n = new Mt.MathNode('mo', [Tt(e.left, e.mode)])
              n.setAttribute('fence', 'true'), r.unshift(n)
            }
            if ('.' !== e.right) {
              var i = new Mt.MathNode('mo', [Tt(e.right, e.mode)])
        ...
        lt({
          ...
          handler: function (e, t) {
            ...
            if (!e.parser.leftrightDepth)
              throw new X('\\middle without preceding \\left', r)
          ...
          mathmlBuilder: function (e, t) {
            var r = new Mt.MathNode('mo', [Tt(e.delim, e.mode)])
      ...
      var fr = function (e, t) {
          var r,
            n,
            i = $e.wrapFragment(bt(e.body, t), t),
            a = e.label.substr(1),
            o = t.sizeMultiplier,
            s = 0,
            l = Y.isCharacterBox(e.body)
          if ('sout' === a)
            ((r = $e.makeSpan(['stretchy', 'sout'])).height =
              t.fontMetrics().defaultRuleThickness / o),
        ...
        gr = function (e, t) {
          var r = new Mt.MathNode('menclose', [qt(e.body, t)])
          switch (e.label) {
            case '\\cancel':
        ...
        lt({
          ...
          handler: function (e, t, r) {
            var n = e.parser,
              i = e.funcName,
              a = t[0]
            return { type: 'enclose', mode: n.mode, label: i, body: a }
          },
          htmlBuilder: fr,
          mathmlBuilder: gr,
        })
      ...
      function xr(e, t, r) {
        ...
        if ((e.gullet.beginGroup(), e.gullet.macros.set('\\\\', '\\cr'), !o)) {
          ...
          if (null == s) o = 1
          else if (!(o = parseFloat(s)) || o < 0)
            throw new X('Invalid \\arraystretch: ' + s)
        }
        var l = [],
          h = [l],
          m = [],
        ...
        for (c.push(br(e)); ; ) {
          ...
          ;(u = { type: 'ordgroup', mode: e.mode, body: u }),
            r && (u = { type: 'styling', mode: e.mode, style: r, body: [u] }),
            l.push(u)
          ...
          if ('&' === p) e.consume()
            ...
            if ('\\end' === p) {
              1 === l.length &&
                ...
                h.pop(),
                c.length < h.length + 1 && c.push([])
              break
            }
            if ('\\cr' !== p)
              throw new X('Expected & or \\\\ or \\cr or \\end', e.nextToken)
            var d = Ze(e.parseFunction(), 'cr')
            m.push(d.size), c.push(br(e)), (l = []), h.push(l)
          }
        }
        return (
          e.gullet.endGroup(),
      ...
      var kr = function (e, t) {
          ...
          function v(e) {
            for (var t = 0; t < e.length; ++t)
              0 < t && (g += 0.25), l.push({ pos: g, isDashed: e[t] })
          }
          for (v(a[0]), r = 0; r < e.body.length; ++r) {
            ...
            for (n = 0; n < y.length; ++n) {
              var k = bt(y[n], t)
              x < k.depth && (x = k.depth),
                b < k.height && (b = k.height),
                (w[n] = k)
            }
            var S = e.rowGaps[r],
              z = 0
            S && 0 < (z = He(S, t)) && (x < (z += f) && (x = z), (z = 0)),
              e.addJot && (x += u),
              (w.height = b),
              (w.depth = x),
              (g += b),
          ...
          for (T = n = 0; n < o || T < B.length; ++n, ++T) {
            for (var N = B[T] || {}, q = !0; 'separator' === N.type; ) {
              if (
                (q ||
                  (((M = $e.makeSpan(['arraycolsep'], [])).style.width =
                    t.fontMetrics().doubleRuleSep + 'em'),
                  C.push(M)),
                '|' === N.separator)
              ) {
                var E = $e.makeSpan(['vertical-separator'], [], t)
                ;(E.style.height = g + 'em'),
                  (E.style.verticalAlign = -(g - A) + 'em'),
                  C.push(E)
              } else {
                if (':' !== N.separator)
                  throw new X('Invalid separator type: ' + N.separator)
                var O = $e.makeSpan(['vertical-separator', 'vs-dashed'], [], t)
                ;(O.style.height = g + 'em'),
                  (O.style.verticalAlign = -(g - A) + 'em'),
                  C.push(O)
              }
              ;(N = B[++T] || {}), (q = !1)
            }
            if (!(o <= n)) {
              var I = void 0
              ;(0 < n || e.hskipBeforeAndAfter) &&
                0 !== (I = Y.deflt(N.pregap, m)) &&
                (((M = $e.makeSpan(['arraycolsep'], [])).style.width =
                  I + 'em'),
                C.push(M))
              var R = []
              for (r = 0; r < i; ++r) {
                ...
                if (H) {
                  ...
                  ;(H.depth = L.depth),
                    (H.height = L.height),
                    R.push({ type: 'elem', elem: H, shift: D })
                }
              }
              ;(R = $e.makeVList(
                ...
                (R = $e.makeSpan(['col-align-' + (N.align || 'c')], [R])),
                C.push(R),
                (n < o - 1 || e.hskipBeforeAndAfter) &&
                  0 !== (I = Y.deflt(N.postgap, m)) &&
                  (((M = $e.makeSpan(['arraycolsep'], [])).style.width =
                    I + 'em'),
                  C.push(M))
            }
          }
          if (((s = $e.makeSpan(['mtable'], C)), 0 < l.length)) {
            for (
              var P = $e.makeLineSpan('hline', t, 0.05),
                F = $e.makeLineSpan('hdashline', t, 0.05),
              ...
              var U = l.pop(),
                G = U.pos - A
              U.isDashed
                ? V.push({ type: 'elem', elem: F, shift: G })
                : V.push({ type: 'elem', elem: P, shift: G })
            }
            s = $e.makeVList(
          ...
          return $e.makeSpan(['mord'], [s], t)
        },
        Sr = function (e, t) {
          return new Mt.MathNode(
            'mtable',
            e.body.map(function (e) {
              return new Mt.MathNode(
                'mtr',
                e.map(function (e) {
                  return new Mt.MathNode('mtd', [qt(e, t)])
                })
              )
            })
          )
        ...
        zr = function (e, t) {
          var n,
            r = [],
            i = xr(e.parser, { cols: r, addJot: !0 }, 'display'),
            a = 0,
            o = { type: 'ordgroup', mode: e.mode, body: [] },
            s = Ke(t[0], 'ordgroup')
          if (s) {
            for (var l = '', h = 0; h < s.body.length; h++) {
              l += Ze(s.body[h], 'textord').text
            }
            ;(n = Number(l)), (a = 2 * n)
          }
          var m = !a
          i.body.forEach(function (e) {
            for (var t = 1; t < e.length; t += 2) {
              Ze(Ze(e[t], 'styling').body[0], 'ordgroup').body.unshift(o)
            }
            if (m) a < e.length && (a = e.length)
              ...
              if (n < r)
                throw new X(
                  'Too many math in a row: expected ' + n + ', but got ' + r,
                  e[0]
                )
            }
          })
          for (var c = 0; c < a; ++c) {
            var u = 'r',
              p = 0
            c % 2 == 1 ? (u = 'l') : 0 < c && m && (p = 1),
              (r[c] = { type: 'align', align: u, pregap: p, postgap: 0 })
          }
          return i
        }
      yr({
        ...
        handler: function (e, t) {
          var r = {
            cols: (Qe(t[0]) ? [t[0]] : Ze(t[0], 'ordgroup').body).map(function (
              e
            ) {
              var t = (function (e) {
                var t = Qe(e)
          ...
          return xr(e.parser, r, wr(e.envName))
        },
        htmlBuilder: kr,
        mathmlBuilder: Sr,
      }),
        yr({
          ...
          handler: function (e) {
            var t = {
              ...
              r = xr(e.parser, { hskipBeforeAndAfter: !1 }, wr(e.envName))
            return t
              ? {
                  type: 'leftright',
                  mode: e.mode,
      ...
      lt({
        ...
        handler: function (e, t) {
          ...
          for (var a = '', o = 0; o < i.body.length; ++o)
            a += Ze(i.body[o], 'textord').text
          if ('\\begin' !== n)
            return { type: 'environment', mode: r.mode, name: a, nameGroup: i }
          if (!Mr.hasOwnProperty(a)) throw new X('No such environment: ' + a, i)
          var s = Mr[a],
          ...
          r.expect('\\end', !1)
          var p = r.nextToken,
            d = Ze(r.parseFunction(), 'environment')
          if (d.name !== a)
            throw new X(
              'Mismatch: \\begin{' + a + '} matched by \\end{' + d.name + '}',
              p
            )
          return u
        },
      ...
      function Br(e, t) {
        var r = Ct(e.body, t)
        return Mt.newDocumentFragment(r)
      }
      lt({
        type: 'mclass',
        names: [
      ...
      var Or = function (e, t) {
          ...
          'display' === e.size
            ? (r = q.DISPLAY)
            : 'text' === e.size && r.size === q.DISPLAY.size
            ? (r = q.TEXT)
            : 'script' === e.size
            ? (r = q.SCRIPT)
            : 'scriptscript' === e.size && (r = q.SCRIPTSCRIPT)
          var n,
            i = r.fracNum(),
            a = r.fracDen()
          n = t.havingStyle(i)
          var o = bt(e.numer, n, t)
          if (e.continued) {
          ...
          if (
            ((c = e.hasBarLine
              ? ((m = (h = e.barSize
                  ? ((m = He(e.barSize, t)), $e.makeLineSpan('frac-line', t, m))
                  : $e.makeLineSpan('frac-line', t)).height),
                h.height)
              : ((h = null), (m = 0), t.fontMetrics().defaultRuleThickness)),
            (d =
              r.size === q.DISPLAY.size
                ? ((u = t.fontMetrics().num1),
                  (p = 0 < m ? 3 * c : 7 * c),
                  t.fontMetrics().denom1)
                : ((p =
                    0 < m
                      ? ((u = t.fontMetrics().num2), c)
                      : ((u = t.fontMetrics().num3), 3 * c)),
                  t.fontMetrics().denom2)),
            h)
          ) {
            var x = t.fontMetrics().axisHeight
            u - o.depth - (x + 0.5 * m) < p &&
              (u += p - (u - o.depth - (x + 0.5 * m))),
              x - 0.5 * m - (b.height - d) < p &&
                (d += p - (x - 0.5 * m - (b.height - d)))
            var w = -(x - 0.5 * m)
            f = $e.makeVList(
              {
                positionType: 'individualShift',
          ...
          return (
            ...
            (v =
              null == e.leftDelim
                ? yt(t, ['mopen'])
                : hr(e.leftDelim, g, !0, t.havingStyle(r), e.mode, ['mopen'])),
            (y = e.continued
              ? $e.makeSpan([])
              : null == e.rightDelim
              ? yt(t, ['mclose'])
              : hr(e.rightDelim, g, !0, t.havingStyle(r), e.mode, ['mclose'])),
            $e.makeSpan(
              ['mord'].concat(n.sizingClasses(t)),
              [v, $e.makeSpan(['mfrac'], [f]), y],
              t
            )
          )
        },
        Ir = function (e, t) {
          ...
          var i = []
          if (null != e.leftDelim) {
            var a = new Mt.MathNode('mo', [new Mt.TextNode(e.leftDelim)])
            a.setAttribute('fence', 'true'), i.push(a)
          }
          if ((i.push(r), null != e.rightDelim)) {
            var o = new Mt.MathNode('mo', [new Mt.TextNode(e.rightDelim)])
      ...
      lt({
        ...
        handler: function (e, t) {
          var r = e.parser,
            ...
            i = t[5],
            a = Ke(t[0], 'ordgroup')
          a = Je(a ? a.body[0] : t[0], 'open')
          var o = Lr(a.text),
            s = Ke(t[1], 'ordgroup')
          s = Je(s ? s.body[0] : t[1], 'close')
          var l,
            h = Lr(s.text),
            m = Ze(t[2], 'size'),
            c = null
          ...
          if (p) {
            if (0 < p.body.length) {
              var d = Ze(p.body[0], 'textord')
              u = Rr[Number(d.text)]
            }
          } else (p = Ze(t[3], 'textord')), (u = Rr[Number(p.text)])
          return {
            type: 'genfrac',
            mode: r.mode,
            numer: n,
      ...
      var Hr = function (e, t) {
        ...
        n = a
          ? ((r = a.sup
              ? bt(a.sup, t.havingStyle(i.sup()), t)
              : bt(a.sub, t.havingStyle(i.sub()), t)),
            Ze(a.base, 'horizBrace'))
          : Ze(e, 'horizBrace')
        var o,
          s = bt(n.base, t.havingBaseStyle(q.DISPLAY)),
          l = Dt(n, t)
        if (
          (n.isOver
            ? (o = $e.makeVList(
          ...
          var h = $e.makeSpan(['mord', n.isOver ? 'mover' : 'munder'], [o], t)
          o = n.isOver
            ? $e.makeVList(
                {
                  positionType: 'firstBaseline',
            ...
            : $e.makeVList(
                {
                  positionType: 'bottom',
                  positionData: h.depth + 0.2 + r.height + r.depth,
                  children: [
                    { type: 'elem', elem: r },
                    { type: 'kern', size: 0.2 },
                    { type: 'elem', elem: h },
        ...
        return $e.makeSpan(['mord', n.isOver ? 'mover' : 'munder'], [o], t)
      }
      lt({
        type: 'horizBrace',
        ...
        lt({
          ...
          handler: function (e, t) {
            var r = e.parser,
              n = t[1],
              i = Ze(t[0], 'url').url
            return { type: 'href', mode: r.mode, href: i, body: mt(n) }
          },
          htmlBuilder: function (e, t) {
            var r = dt(e.body, t, !1)
          ...
          mathmlBuilder: function (e, t) {
            var r = Nt(e.body, t)
            return (
              r instanceof St || (r = new St('mrow', [r])),
        ...
        lt({
          ...
          handler: function (e, t) {
            for (
              var r = e.parser, n = Ze(t[0], 'url').url, i = [], a = 0;
              a < n.length;
              a++
            ) {
              var o = n[a]
        ...
        lt({
          ...
          htmlBuilder: function (e, t) {
            ...
            r =
              'clap' === e.alignment
                ? ((r = $e.makeSpan([], [bt(e.body, t)])),
                  $e.makeSpan(['inner'], [r], t))
                : $e.makeSpan(['inner'], [bt(e.body, t)])
            var n = $e.makeSpan(['fix'], []),
              i = $e.makeSpan([e.alignment], [r, n], t),
              a = $e.makeSpan(['strut'])
            return (
      ...
      var Pr = function (e, t) {
          var r,
            ...
            o = Ke(e, 'supsub')
          o
            ? ((r = o.sup), (n = o.sub), (i = Ze(o.base, 'op')), (a = !0))
            : (i = Ze(e, 'op'))
          var s,
            l = t.style,
            h = !1
          if (
            (l.size === q.DISPLAY.size &&
              i.symbol &&
              !Y.contains(['\\smallint'], i.name) &&
              (h = !0),
            i.symbol)
          ) {
            ...
            if (
              ...
              (s = $e.makeSymbol(i.name, m, 'math', t, [
                'mop',
                'op-symbol',
                h ? 'large-op' : 'small-op',
              ])),
            ...
            var d = dt(i.body, t, !0)
            1 === d.length && d[0] instanceof O
              ? ((s = d[0]).classes[0] = 'mop')
              : (s = $e.makeSpan(['mop'], $e.tryCombineChars(d), t))
          } else {
            for (var f = [], g = 1; g < i.name.length; g++)
              f.push($e.mathsym(i.name[g], i.mode))
            s = $e.makeSpan(['mop'], f, t)
          }
          var v = 0,
            y = 0
          if (
            ...
            var b, x, w
            if (((s = $e.makeSpan([], [s])), r)) {
              var k = bt(r, t.havingStyle(l.sup()), t)
              x = {
                elem: k,
                kern: Math.max(
                  t.fontMetrics().bigOpSpacing1,
                  t.fontMetrics().bigOpSpacing3 - k.depth
                ),
              }
            }
            if (n) {
              var S = bt(n, t.havingStyle(l.sub()), t)
              b = {
                elem: S,
                kern: Math.max(
            ...
            return $e.makeSpan(['mop', 'op-limits'], [w], t)
          }
          return (
            v && ((s.style.position = 'relative'), (s.style.top = v + 'em')), s
          )
        },
        Fr = function (e, t) {
          var r
          if (e.symbol) r = new St('mo', [Tt(e.name, e.mode)])
          else {
            if (!e.body)
              return kt([
                (r = new St('mi', [new zt(e.name.slice(1))])),
                new St('mo', [Tt('\u2061', 'text')]),
              ])
            r = new St('mo', Ct(e.body, t))
          }
          return r
        },
        Vr = {
      ...
      function Gr(e, t, r) {
        for (
          var n = dt(e, t, !1), i = t.sizeMultiplier / r.sizeMultiplier, a = 0;
          a < n.length;
          a++
        ) {
      ...
      lt({
        ...
        handler: function (e) {
          var t = e.parser,
            r = e.funcName
          return { type: 'op', mode: t.mode, limits: !1, symbol: !1, name: r }
        },
        htmlBuilder: Pr,
        mathmlBuilder: Fr,
      }),
        lt({
          ...
          handler: function (e) {
            var t = e.parser,
              r = e.funcName
            return { type: 'op', mode: t.mode, limits: !0, symbol: !1, name: r }
          },
          htmlBuilder: Pr,
          mathmlBuilder: Fr,
        }),
        lt({
          ...
          handler: function (e) {
            ...
            return (
              1 === r.length && (r = Ur[r]),
              { type: 'op', mode: t.mode, limits: !1, symbol: !0, name: r }
            )
          },
          htmlBuilder: Pr,
          mathmlBuilder: Fr,
        ...
        lt({
          ...
          handler: function (e, t) {
            var r = e.parser,
              n = t[0]
            return { type: 'operatorname', mode: r.mode, body: mt(n) }
          },
          htmlBuilder: function (e, t) {
            if (0 < e.body.length) {
              for (
              ...
              return $e.makeSpan(['mop'], n, t)
            }
            return $e.makeSpan(['mop'], [], t)
          },
          mathmlBuilder: function (e, t) {
            for (
              var r = Ct(e.body, t.withFont('mathrm')), n = !0, i = 0;
              i < r.length;
              i++
            ) {
              var a = r[i]
              if (a instanceof Mt.SpaceNode);
              else if (a instanceof Mt.MathNode)
                switch (a.type) {
                  case 'mi':
                  case 'mn':
                  case 'ms':
                  ...
                  case 'mo':
                    var o = a.children[0]
                    1 === a.children.length && o instanceof Mt.TextNode
                      ? (o.text = o.text
                          .replace(/\u2212/, '-')
                          .replace(/\u2217/, '*'))
                      : (n = !1)
            ...
            if (n) {
              var s = r
                ...
                .join('')
              r = [new Mt.TextNode(s, !1)]
            }
            var l = new Mt.MathNode('mi', r)
            l.setAttribute('mathvariant', 'normal')
            var h = new Mt.MathNode('mo', [Tt('\u2061', 'text')])
            return Mt.newDocumentFragment([l, h])
          },
        }),
        ht({
          type: 'ordgroup',
          htmlBuilder: function (e, t) {
            return $e.makeSpan(['mord'], dt(e.body, t, !0), t)
          },
          mathmlBuilder: function (e, t) {
            return Nt(e.body, t)
          },
      ...
      lt({
        ...
        lt({
          ...
          htmlBuilder: function (e, t) {
            var r = $e.makeSpan(['mord', 'rule'], [], t),
              n = 0
            e.shift && (n = He(e.shift, t))
            var i = He(e.width, t),
              a = He(e.height, t)
            return (
              (r.style.borderRightWidth = i + 'em'),
        ...
        lt({
          ...
          htmlBuilder: function (e, t) {
            var r = $e.makeSpan(['mord'], [bt(e.body, t)])
        ...
        htmlBuilder: function (e, t) {
              ...
              (i = (r = e).base)
                ? 'op' !== i.type
                  ? 'accent' === i.type
                    ...
                    : null
                  : i.limits &&
                    (n.style.size === q.DISPLAY.size || i.alwaysHandleSupSub)
                  ? Pr
                  : null
                : null)
          if (a) return a(e, t)
          ...
          if (m) {
            ...
            ;(o = bt(m, v, t)),
              g ||
                (d =
                  u.height -
                  (v.fontMetrics().supDrop * v.sizeMultiplier) /
                    t.sizeMultiplier)
          }
          if (c) {
          ...
          if (o && s) {
            ...
            var T = [
              ...
              { type: 'elem', elem: o, shift: -d, marginRight: w },
            ]
            b = $e.makeVList(
            ...
            f = Math.max(f, p.sub1, s.height - 0.8 * p.xHeight)
            var A = [{ type: 'elem', elem: s, marginLeft: k, marginRight: w }]
            b = $e.makeVList(
              { positionType: 'shift', positionData: f, children: A },
              t
            )
          } else {
              ...
              (b = $e.makeVList(
                {
                  positionType: 'shift',
                  positionData: -d,
                  children: [{ type: 'elem', elem: o, marginRight: w }],
                },
                t
              ))
          }
          var B = gt(u, 'right') || 'mord'
          return $e.makeSpan([B], [u, $e.makeSpan(['msupsub'], [b])], t)
        },
        mathmlBuilder: function (e, t) {
          var r,
            n = !1,
          ...
          var a,
            o = [qt(e.base, t)]
          if ((e.sub && o.push(qt(e.sub, t)), e.sup && o.push(qt(e.sup, t)), n))
            a = r ? 'mover' : 'munder'
          else if (e.sub)
            if (e.sup) {
              var s = e.base
              a =
                s && 'op' === s.type && s.limits && t.style === q.DISPLAY
                  ? 'munderover'
                  : 'msubsup'
            } else {
              var l = e.base
              a =
                l && 'op' === l.type && l.limits && t.style === q.DISPLAY
                  ? 'munder'
                  : 'msub'
            }
          else {
            var h = e.base
            a =
              h && 'op' === h.type && h.limits && t.style === q.DISPLAY
                ? 'mover'
                : 'msup'
          }
          return new Mt.MathNode(a, o)
        },
      }),
        ht({
          type: 'atom',
          ...
          mathmlBuilder: function (e, t) {
            var r = new Mt.MathNode('mo', [Tt(e.text, e.mode)])
            if ('bin' === e.family) {
              var n = Bt(e, t)
      ...
      var Wr = { mi: 'italic', mn: 'normal', mtext: 'normal' }
      ht({
        type: 'mathord',
        htmlBuilder: function (e, t) {
        ...
        mathmlBuilder: function (e, t) {
          var r = new Mt.MathNode('mi', [Tt(e.text, e.mode, t)]),
            n = Bt(e, t) || 'italic'
          return n !== Wr[r.type] && r.setAttribute('mathvariant', n), r
        },
      }),
        ht({
          type: 'textord',
          ...
          mathmlBuilder: function (e, t) {
            ...
            return (
              ...
              i !== Wr[r.type] && r.setAttribute('mathvariant', i),
              r
            )
          },
        })
      ...
      ht({
        type: 'spacing',
        htmlBuilder: function (e, t) {
          if ($r.hasOwnProperty(e.text)) {
            var r = $r[e.text].className || ''
            if ('text' !== e.mode)
              return $e.makeSpan(
                ['mspace', r],
                [$e.mathsym(e.text, e.mode, t)],
                t
              )
            var n = $e.makeOrd(e, t, 'textord')
            return n.classes.push(r), n
          }
          if (jr.hasOwnProperty(e.text))
            return $e.makeSpan(['mspace', jr[e.text]], [], t)
          throw new X('Unknown type of space "' + e.text + '"')
        },
        mathmlBuilder: function (e, t) {
          if ($r.hasOwnProperty(e.text))
            return new Mt.MathNode('mtext', [new Mt.TextNode('\xa0')])
          if (jr.hasOwnProperty(e.text)) return new Mt.MathNode('mspace')
          throw new X('Unknown type of space "' + e.text + '"')
        },
      }),
        ht({
      ...
      var Zr = {
        ...
        Qr = function (e, t) {
          ...
          return r
            ? Zr[r]
              ? t.withTextFontFamily(Zr[r])
              : Kr[r]
              ? t.withTextFontWeight(Kr[r])
              : t.withTextFontShape(Jr[r])
            : t
        }
      lt({
        type: 'text',
        ...
        handler: function (e, t) {
          var r = e.parser,
            n = e.funcName,
            i = t[0]
          return { type: 'text', mode: r.mode, body: mt(i), font: n }
        },
        htmlBuilder: function (e, t) {
          var r = Qr(e, t),
            n = dt(e.body, r, !0)
          return $e.makeSpan(['mord', 'text'], $e.tryCombineChars(n), r)
        },
        mathmlBuilder: function (e, t) {
          var r = Qr(e, t)
          return Nt(e.body, r)
        ...
        lt({
          ...
          htmlBuilder: function (e, t) {
            for (
              var r = en(e), n = [], i = t.havingStyle(t.style.text()), a = 0;
              a < r.length;
              a++
            ) {
              var o = r[a]
              '~' === o && (o = '\\textasciitilde'),
                n.push(
                  $e.makeSymbol(o, 'Typewriter-Regular', e.mode, i, [
                    'mord',
                    'texttt',
                  ])
                )
              ...
              (e.prototype.lex = function () {
                ...
                if (null === r || r.index !== t)
                  throw new X(
                    ...
                    new a(e[t], new p(this, t, t + 1))
                  )
                var n = r[2] || ' ',
                  i = n.match(an)
                return (
                  i && (n = i[1]),
                  new a(n, new p(this, t, this.tokenRegex.lastIndex))
                )
              }),
              e
            )
      ...
      un('\\char', function (e) {
        ...
        if (t) {
          if (null == (n = pn[r.text]) || t <= n)
            throw new X('Invalid base-' + t + ' digit ' + r.text)
      ...
      var dn = function (e, t) {
        ...
        if (1 !== r.length)
          throw new X("\\gdef's first argument must be a macro name")
        var n = r[0].text,
          i = 0
        for (r = e.consumeArgs(1)[0]; 1 === r.length && '#' === r[0].text; ) {
          ...
          if (!/^[1-9]$/.test(r[0].text))
            throw new X('Invalid argument number "' + r[0].text + '"')
          if ((i++, parseInt(r[0].text) !== i))
            throw new X('Argument number "' + r[0].text + '" out of order')
          r = e.consumeArgs(1)[0]
        }
      ...
      un('\\newcommand', function (e) {
        ...
        un('\\renewcommand', function (e) {
          return fn(e, !0, !1)
        }),
        un('\\providecommand', function (e) {
          return fn(e, !0, !0)
        }),
        un('\\bgroup', '{'),
        un('\\egroup', '}'),
        ...
        un('\\aa', '\\r a'),
        un('\\AA', '\\r A'),
        un('\\textcopyright', '\\html@mathml{\\textcircled{c}}{\\char`\xa9}'),
        un(
          '\\copyright',
      ...
      un('\\dots', function (e) {
        ...
        return (
          r in gn
            ...
            ? (t = '\\dotsb')
            : r in W.math &&
              Y.contains(['bin', 'rel'], W.math[r].group) &&
              (t = '\\dotsb'),
          t
        )
      })
      ...
      var yn =
        H['Main-Regular']['T'.charCodeAt(0)][1] -
        0.7 * H['Main-Regular']['A'.charCodeAt(0)][1] +
        'em'
      un(
        '\\LaTeX',
        ...
        un('\\coloneqq', '\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}=}'),
        un('\\Coloneqq', '\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}=}'),
        un(
          '\\coloneq',
        ...
        un('\\eqqcolon', '\\mathrel{=\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
        un('\\Eqqcolon', '\\mathrel{=\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
        un(
          '\\eqcolon',
        ...
        un('\\Colonsim', '\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\sim}'),
        un('\u2254', '\\coloneqq'),
        un('\u2255', '\\eqqcolon'),
        un('\u2a74', '\\Coloneqq'),
        un('\\ratio', '\\vcentcolon'),
        ...
        un('\\notni', '\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}'),
        un('\\limsup', '\\DOTSB\\mathop{\\operatorname{lim\\,sup}}\\limits'),
        un('\\liminf', '\\DOTSB\\mathop{\\operatorname{lim\\,inf}}\\limits'),
        un('\u27e6', '\\mathopen{[\\mkern-3.2mu[}'),
        un('\u27e7', '\\mathclose{]\\mkern-3.2mu]}'),
        un('\\darr', '\\downarrow'),
        un('\\dArr', '\\Downarrow'),
        un('\\Darr', '\\Downarrow'),
        un('\\lang', '\\langle'),
      ...
      var bn = {
        ...
        xn = (function () {
          function e(e, t, r) {
            ;(this.settings = void 0),
              ...
              this.feed(e),
              (this.macros = new hn(cn, t.macros)),
              (this.mode = r),
              (this.stack = [])
          }
          var t = e.prototype
          return (
                ...
                if ('{' === n.text) {
                  for (var i = [], a = 1; 0 !== a; ) {
                    ...
                    if ((i.push(o), '{' === o.text)) ++a
                      ...
                      throw new X('End of input in macro argument', n)
                  }
                  i.pop(), i.reverse(), (t[r] = i)
                } else {
                  if ('EOF' === n.text)
                    throw new X('End of input expecting macro argument')
                  t[r] = [n]
                }
              }
              return t
            ...
            (t.expandOnce = function () {
              ...
              if (r.numArgs)
                for (
                  var i = this.consumeArgs(r.numArgs),
                    a = (n = n.slice()).length - 1;
                  0 <= a;
                  --a
                ) {
                  var o = n[a]
            ...
            (t._getExpansion = function (e) {
              ...
              if (-1 !== r.indexOf('#'))
                for (
                  ...
                  ++n
              for (var a = new ln(r), o = [], s = a.lex(); 'EOF' !== s.text; )
                o.push(s), (s = a.lex())
            ...
            (t.isDefined = function (e) {
              return (
                this.macros.has(e) ||
                tn.hasOwnProperty(e) ||
                W.math.hasOwnProperty(e) ||
                W.text.hasOwnProperty(e) ||
                bn.hasOwnProperty(e)
              )
            }),
            e
        ...
        Sn = (function () {
          ...
          var e = a.prototype
          return (
            (e.expect = function (e, t) {
              if ((void 0 === t && (t = !0), this.nextToken.text !== e))
                throw new X(
            ...
            (e.parseExpression = function (e, t) {
              for (var r = []; ; ) {
                ...
                if (-1 !== a.endOfExpression.indexOf(n.text)) break
                if (t && n.text === t) break
                if (e && tn[n.text] && tn[n.text].infix) break
            ...
            (e.handleInfixNodes = function (e) {
              ...
              if (-1 !== r && t) {
                ...
                return (
                  ...
                  [
                    '\\\\abovefrac' === t
                      ? this.callFunction(t, [a, e[r], o], [])
                      : this.callFunction(t, [a, o], []),
                  ]
                )
              }
              return e
            ...
            (e.handleSupSubscript = function (e) {
              ...
              var n = this.parseGroup(e, !1, a.SUPSUB_GREEDINESS)
            ...
            (e.parseAtom = function (e) {
              ...
              return t || r
                ? { type: 'supsub', mode: this.mode, base: n, sup: t, sub: r }
                : n
            }),
            ...
            (e.parseArguments = function (e, t) {
              ...
              for (var n = t.greediness, i = [], a = [], o = 0; o < r; o++) {
                ...
                0 < o && !l && this.consumeSpaces(),
                  0 !== o || l || 'math' !== this.mode || this.consumeSpaces()
            ...
            (e.consumeComment = function () {
              for (
                ...
                this.nextToken.loc &&
                -1 === this.nextToken.loc.getSource().indexOf('\n');
            ...
            (e.parseStringGroup = function (e, t, r) {
              ...
              if (a.text !== n) {
                if (t) return null
                if (r && 'EOF' !== a.text && /[^{}[\]]/.test(a.text))
                  return this.consume(), a
              }
              var o = this.mode
              ;(this.mode = 'text'), this.expect(n)
              for (
                var s = '', l = this.nextToken, h = 0, m = l;
                (r && 0 < h) || this.nextToken.text !== i;
            ...
            (e.parseSizeGroup = function (e) {
              ...
              var i,
                a = { number: +(n[1] + n[2]), unit: n[3] }
              if (
                ('string' != typeof (i = a) && (i = i.unit),
                !(i in Re || i in Le || 'ex' === i))
              )
            ...
            (e.parseUrlGroup = function (e) {
              ...
              if (!Y.contains(i, '*') && !Y.contains(i, n))
                throw new X("Forbidden protocol '" + n + "'", t)
            ...
            (e.parseGroup = function (e, t, r, n, i) {
              var a,
                ...
                s = this.nextToken,
                l = s.text
              if ((i && this.switchMode(i), l === (t ? '[' : '{'))) {
                this.gullet.beginGroup(), this.consume()
                var h = this.parseExpression(!1, t ? ']' : '}'),
                  m = this.nextToken
                return (
                  i && this.switchMode(o),
              ...
              if (t) a = null
                ...
                null ==
                  (a = this.parseFunction(n, e, r) || this.parseSymbol()) &&
                '\\' === l[0] &&
                !bn.hasOwnProperty(l)
              ) {
                if (this.settings.throwOnError)
                  throw new X('Undefined control sequence: ' + l, s)
                a = this.handleUnsupportedCmd()
              }
              return i && this.switchMode(o), a
            }),
            ...
            (e.parseSymbol = function () {
              ...
              if ((this.consume(), a))
                for (var m = 0; m < a[0].length; m++) {
                  var c = a[0][m]
                  if (!wn[c]) throw new X("Unknown accent ' " + c + "'", e)
                  var u = wn[c][this.mode]
                  if (!u)
                    throw new X(
      ...
      ;(Sn.endOfExpression = ['}', '\\end', '\\right', '&']),
        (Sn.SUPSUB_GREEDINESS = 1)
      var zn = function (e, t) {
      ...
      var Tn = function (e, t, r) {
          ...
          var n = $e.makeSpan(['katex-error'], [new O(t)])
          return (
        ...
        Bn = {
          ...
          __renderToHTMLTree: function (t, e) {
            ...
            try {
              ...
              return (
                (n = wt(o, Et((r = a)))),
                (i = $e.makeSpan(['katex'], [n])),
                r.displayMode ? $e.makeSpan(['katex-display'], [i]) : i
              )
            } catch (e) {
              return Tn(e, t, a)
            }
