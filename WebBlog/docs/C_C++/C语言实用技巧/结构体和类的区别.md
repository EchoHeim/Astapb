...
date: 2022-06-23
tags: [C/C++, C 语言技巧]
summary: C++ 中的 struct 对 C 语言中的 struct 进行了扩充，它已经不再只是一个包含不同数据类型的数据结构了，而是具有了更多的功能：能包含成员函数、能继承、能实现多态！
---
### <center> <font size=34 face="STKaiti"> 结构体和类的区别 </font>    <!-- {docsify-ignore} -->
